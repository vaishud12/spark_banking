...
<body style="background: url(images/bank.jpg);background-size: 100%">
<h1 class="alert alert-success rounded-0"><small class="float-right text-muted" style="font-size: 12pt;"><kbd>vaishu</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
